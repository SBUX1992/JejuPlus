...
CREATE TABLE IF NOT EXISTS `jejuplus`.`tb_place` (
  ...
  `contenttypeid` VARCHAR(50) NULL DEFAULT NULL,
  `addr1` VARCHAR(50) NOT NULL,
  `addr2` VARCHAR(50) NOT NULL,
  `contentid` VARCHAR(50) NULL DEFAULT NULL,
  ...
  INDEX `tb_place_ibfk_1` (`contenttypeid` ASC) VISIBLE,
